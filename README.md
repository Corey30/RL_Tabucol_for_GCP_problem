...
## run example
1: RLTabucol0: ```python batch_runner.py dummy.pt instance.col color_num output_dir 
--time-limit 18000 --RL False --num-jobs 10 --concurrency 2 ``` 

2: RL-Tabucol: ```python batch_runner.py dummy.pt instance.col color_num output_dir 
--time-limit 18000 --RL True --num-jobs 10 --concurrency 2 ``` 

3: ACO-RL-Tabucol: ```python batch_runner.py dummy.pt instance.col color_num output_dir 
--time-limit 18000 --RL True --num-jobs 10 --concurrency 2 ```
